...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      support_tickets: {
        Row: {
          ...
          last_message_sender: Database["public"]["Enums"]["chat_sender_type"] | null;
    ...
    Enums: {
      ...
      request_status: "pending" | "approved" | "rejected" | "failed" | "uncertain";
      ticket_status: "new" | "waiting" | "assigned" | "in_progress" | "resolved" | "closed";
    };
    CompositeTypes: {
      [_ in never]: never;
    };
...
export const Constants = {
  public: {
    Enums: {
      app_role: ["super_admin", "admin", "finance_agent", "support_agent"],
      chat_sender_type: ["player", "staff", "bot", "system"],
      ledger_type: ["deposit", "cashout", "manual_credit", "manual_debit", "adjustment", "bonus"],
      player_status: ["active", "suspended", "blocked", "pending_kyc"],
      request_status: ["pending", "approved", "rejected", "failed", "uncertain"],
      ticket_status: ["new", "waiting", "assigned", "in_progress", "resolved", "closed"],
    },
